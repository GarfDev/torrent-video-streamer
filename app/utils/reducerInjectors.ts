...
import { InjectedStore as LifeStore } from 'types';
...
function combineInjectedReducers(injectedReducers: any) {
  ...
  const combinedReducerObject: any = {};
...
function replaceInjectedReducers(rootReducers: any, keys: string[], reducer: Reducer<object>): any {
